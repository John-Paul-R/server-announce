        ...
        CommandRegistrationCallback.EVENT.register((
            ...
            dispatcher.register(CommandManager.literal("serverannounce")
                ...
                .then(CommandManager.literal("create")
                    ...
                    .then(PeriodicSingleMessage.getCreateCommandBuilder(registryAccess))
                    .then(SingleMessage.getCreateCommandBuilder(registryAccess))
                )
                .then(CommandManager.literal("edit")
                    .then(PeriodicMessageGroup.getEditCommandBuilder(registryAccess))
